...
Findings are dated by the application/iteration they informed — resume
"best practice" shifts over time and by source quality, so treat these
as a starting point to sanity-check against current sources, not an
permanent ruling.
